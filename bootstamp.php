...
<form action="home.php" method="POST">
		<table class="table table-bordered">
			<tr><td align="left">
				...
				<td>
					<input type="text" name="name" id="name" placeholder="Enter Your Search">
					
				</td>
				<td colspan="2" align="center"><input class="btn btn-info" role="button" type="submit" value="Search"></td>
		   	</tr></table></form><br>
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<a href='bootstamp.php?page=".$i."'>   ".$i." </a>";  
};  
